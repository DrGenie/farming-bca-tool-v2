...
(() => {
  ...
  function bind() {
    ...
    const handleApplySettings = () => {
      try {
        ...
        if (ok) {
          ...
          if (status) {
            status.className = 'message success';
            status.textContent = status.textContent || 'Settings applied.';
    ...
    if (applyBtn) {
      applyBtn.addEventListener('click', handleApplySettings, { passive: false });
      applyBtn.addEventListener('touchend', handleApplySettings, { passive: false });
      applyBtn.addEventListener('pointerup', handleApplySettings, { passive: false });
      window.forceApplySettings = handleApplySettings;
      window.appApplySettings = handleApplySettings;
    }
